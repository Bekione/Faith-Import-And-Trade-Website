...
const NotFound = () => {
    return (
      <>
        <section className="relative z-10 pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px] bg-gradient-to-b from-primary via-5% via-secondary to-secondary/60">
          <div className="container">
            <div className="flex flex-wrap -mx-4">
              <div className="w-full px-4">
                <div className="mx-auto max-w-[530px] text-center z-[50]">
                  <div className="mx-auto text-center mb-9">
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          <stop stopColor="#151f34" stopOpacity="0" />
                          <stop offset="1" stopColor="#151f34" />
                        </linearGradient>
                        <linearGradient
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-white sm:text-lg sm:leading-relaxed">
